    ...
    export function showText(text:string) {
        ...
        for(let i = 0; i < text.length; i++) {
            ...
            // 0-9
                ...
                index = charCode - 48 + 53
            }

            // ! $ % * , ( )
            else if(charCode == 33) { index = 63 } // !
            else if(charCode == 36) { index = 64 } // $
            else if(charCode == 37) { index = 65 } // %
            else if(charCode == 42) { index = 66 } // *
            else if(charCode == 44) { index = 67 } // ,
            else if(charCode == 40) { index = 68 } // (
            else if(charCode == 41) { index = 69 } // )
